...
def process_frame(frame_queue):
    ...
    while True:
        ...
        # --------------------------------------------------------HP and AC--------------------------------------------------------#
            part2_hp = image[int(1399 * height / 1440):int(1413 * height / 1440),int(167 * width / 2560):int(274 * width / 2560)]
            ...
            part2_ac = image[int(1399 * height / 1440):int(1413 * height / 1440),int(445 * width / 2560):int(552 * width / 2560)]
