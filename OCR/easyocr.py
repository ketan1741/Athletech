...
image = cv2.imread('./picture/image2.png')
...
part4_kill1 = image[int(100*height/1440):int(143*height/1440),  int(2000*width/2560):int(2550*width/2560)]
part4_kill2 = image[int(147*height/1440):int(190*height/1440),  int(2000*width/2560):int(2550*width/2560)]
part4_kill3 = image[int(194*height/1440):int(237*height/1440),  int(2000*width/2560):int(2550*width/2560)]
part4_kill4 = image[int(241*height/1440):int(284*height/1440),  int(2000*width/2560):int(2550*width/2560)]
part4_kill5 = image[int(288*height/1440):int(331*height/1440),  int(2000*width/2560):int(2550*width/2560)]

part4_concate = np.concatenate((part4_kill1, part4_kill2, part4_kill3, part4_kill4, part4_kill5), axis = 0)   # vertical
