...
void setup(void)
{
  ...
  Serial.println("Wearable IMU System"); Serial.println("");
...
void loop(void)
{
  ...
  imu::Vector<3> accel_l1 = bno_l1.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
  tcaselect(3);
  imu::Vector<3> gyro_r1 = bno_r1.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);
  imu::Vector<3> accel_r1 = bno_r1.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
  tcaselect(4);
  imu::Vector<3> gyro_l2 = bno_l2.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);
  imu::Vector<3> accel_l2 = bno_l2.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
  tcaselect(5);
  imu::Vector<3> gyro_r2 = bno_r2.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);
  imu::Vector<3> accel_r2 = bno_r2.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
  tcaselect(6);
  imu::Vector<3> gyro_l3 = bno_l3.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);
  imu::Vector<3> accel_l3 = bno_l3.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
  tcaselect(7);
  imu::Vector<3> gyro_r3 = bno_r3.getVector(Adafruit_BNO055::VECTOR_GYROSCOPE);
  imu::Vector<3> accel_r3 = bno_r3.getVector(Adafruit_BNO055::VECTOR_ACCELEROMETER);
